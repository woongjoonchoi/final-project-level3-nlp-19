...
from inference_copy import run_retrieval_date
...
def get_prediction(model, tokenizer, questions, date_range):
    ...
    for idx, question in enumerate(questions["data"]):
        ...
        sample_test["data"].append(sample)
    ...
    datasets, df = run_retrieval_date(
            tokenizer,
            datasets,
            training_args,
            data_args,
